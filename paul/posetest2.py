...
while True:
    ...
    corners = cv2.cornerHarris(np.float32(greenscale), 2, 3, 0.04)
    ...
    cactual = (corners > 0.008 * corners.max()) & zer.astype(np.bool_) #eroded_hsv
    ...
    if fc:
        ...
        if len(c_exact) == 8:
            ...
            cv2.putText(fr,str(len(c_exact)),(600, 25), cv2.FONT_HERSHEY_SIMPLEX, 1,(255,255,255),1,cv2.LINE_AA)
